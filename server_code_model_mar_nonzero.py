...
def load_train_data():
    imgs_train = np.load('nonzero_imgs_train2021mar.npy')
    masks_train = np.load('nonzero_masks_train2021mar.npy')
...
my_callbacks = [ModelCheckpoint('nonzero_weights.h5', monitor='dice_coef', save_best_only=True)] 
...
model.load_weights('nonzero_weights.h5')
